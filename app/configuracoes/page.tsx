...
import {
  ...
  ShieldEllipsis, CheckCircle2, Eye, EyeOff, UserCircle
} from "lucide-react";
      ...
      {showPassModal && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-xl z-[100] flex items-center justify-center p-6">
          <div className="bg-white w-full max-w-md rounded-[3.5rem] p-12 shadow-2xl relative border border-gray-100 animate-in zoom-in-95 duration-300">
            ...
            {passSuccessMessage ? (
              <div className="bg-emerald-50 border border-emerald-100 p-6 rounded-3xl text-center space-y-2 animate-in fade-in duration-300">
                <CheckCircle2 size={36} className="text-emerald-600 mx-auto" />
                <p className="text-emerald-800 font-bold text-sm">{passSuccessMessage}</p>
