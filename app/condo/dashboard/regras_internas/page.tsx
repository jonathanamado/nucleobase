// app/condo/dashboard/regras_internas/page.tsx
"use client";
import React from "react";
import Link from "next/link";
import { BookOpen, ArrowLeft, Instagram, Construction } from "lucide-react";
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 pb-6 mb-8">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-teal-50 text-teal-600 rounded-2xl flex items-center justify-center shadow-sm shrink-0">
                            <BookOpen size={24} />
                        </div>
                        <div>
                            <span className="text-xs font-bold text-teal-600 uppercase tracking-widest">Normas e Diretrizes</span>
                            <h1 className="text-2xl md:text-3xl font-black tracking-tight mt-1 text-zinc-900">Regras Internas</h1>
                        </div>
                    </div>
                ...
                <div className="max-w-4xl mx-auto my-12 bg-white border border-zinc-200 rounded-[2.5rem] p-8 md:p-12 shadow-sm text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <span className="text-[10px] font-black text-teal-600 uppercase tracking-[0.3em]">Em fase de elaboração</span>
                        ...
                        <p className="text-sm text-zinc-500 max-w-lg mx-auto leading-relaxed">
                            Em breve, todas as normativas oficiais, convenção condominial e regimento interno estarão centralizados aqui com total transparência e praticidade.
                        </p>
                    </div>
