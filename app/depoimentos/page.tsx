...
export default function DepoimentosPage() {
  ...
  return (
    <div className="w-full md:pr-10 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20 relative px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 md:gap-y-12 items-start mb-32">
              ...
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <p className="font-black text-gray-900 text-xs md:text-sm uppercase tracking-[0.1em] leading-tight">
                        {nomeExibicao}
                      </p>
                      <p className="text-[10px] md:text-[11px] text-blue-600 font-bold uppercase tracking-widest mt-1">
                        {cargoExibicao}
                      </p>
                    </div>
                  </div>

                  <div className="flex gap-0.5 sm:self-start bg-gray-50 sm:bg-transparent p-2 sm:p-0 rounded-lg w-fit">
                ...
                <div className="relative min-h-[80px] md:min-h-[100px] flex items-center text-left">
                  <p className="text-gray-700 text-xl md:text-2xl leading-relaxed font-medium italic tracking-tight">
                    "{item.content}"
                  </p>
                </div>
              </div>
      ...
      {/* LINHA DIVISÓRIA PARA O INSTAGRAM */}
