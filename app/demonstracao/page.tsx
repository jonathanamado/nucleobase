...
export default function DemonstracaoPlataforma() {
  ...
  useEffect(() => {
    window.dataLayer?.push({
      ...
      content_name: "pagina_demonstracao"
    });
    ...
    <div className="w-full md:pr-10 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20 relative px-4 md:px-0">
      ...
      <div className="mt-20 bg-gray-900 rounded-[3rem] p-10 md:p-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a href="/cadastro" onClick={() => trackClick("Começar Agora Gratuitamente", "/cadastro")} className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-bold text-sm hover:bg-blue-700 transition-all cursor-pointer">
              Começar agora gratuitamente
            </a>
            <a href="/sobre" onClick={() => trackClick("Conhecer Nossa História", "/sobre")} className="bg-white/5 text-white border border-white/10 px-8 py-4 rounded-2xl font-bold text-sm hover:bg-white/10 transition-all cursor-pointer">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <a
          ...
          onClick={() => trackClick("Instagram - Demonstração", "https://www.instagram.com/nucleobase.app/")}
