    ...
    <div className="w-full pr-10 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20 relative px-4 md:px-0">
      ...
      <div className="flex flex-col mb-12">
        ...
        <h1 className="text-5xl font-bold text-gray-900 tracking-tight mb-4">
          Controle prático, <br />resultado <span className="text-blue-600">profissional.</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white border border-gray-100 rounded-[2rem] shadow-sm">
              <div className="text-blue-600 mb-4 bg-blue-50 w-fit p-3 rounded-2xl">
        ...
        <div className="lg:col-span-5 sticky top-8">
          <div className="bg-white border-2 border-blue-600 rounded-[3rem] p-8 shadow-2xl shadow-blue-100">
            <div className="text-center mb-8">
              <span className="bg-blue-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest">Plano Mensal</span>
              <div className="mt-6">
                <span className="text-6xl font-black text-gray-900 tracking-tighter transition-all">R$ 9,90</span>
                <span className="text-gray-400 font-bold block mt-2 tracking-widest uppercase text-xs">por mês</span>
              </div>
            </div>

            <div className="space-y-4">
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-center mb-2">Assinar via Cartão de Crédito</p>
              <CheckoutForm 
                lookupKey="essencial_mensal" 
                label="Começar Assinatura Mensal" 
                description="Plano Essencial Mensal"
                className="w-full py-5 bg-gray-900 text-white rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-black shadow-lg shadow-gray-200 transition-all"
              />

              <div className="pt-6 border-t border-gray-100">
                <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] text-center mb-4">Ou economize com ciclos longos:</p>
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex items-center gap-3">
                    <CheckoutForm 
                      ...
                      className="flex-1 py-4 bg-blue-50 text-blue-600 rounded-xl font-bold text-xs hover:bg-blue-100 transition-colors"
                    />
                    <span className="text-[10px] font-bold text-emerald-500 bg-emerald-50 px-2 py-1 rounded-md">-10%</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckoutForm 
                      ...
                      className="flex-1 py-4 bg-blue-50 text-blue-600 rounded-xl font-bold text-xs hover:bg-blue-100 transition-colors"
                    />
                    <span className="text-[10px] font-bold text-emerald-500 bg-emerald-50 px-2 py-1 rounded-md">-16%</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckoutForm 
                      ...
                      className="flex-1 py-4 bg-blue-600 text-white rounded-xl font-bold text-xs hover:bg-blue-700 transition-colors shadow-md"
                    />
                    <span className="text-[10px] font-bold text-white bg-orange-500 px-2 py-1 rounded-md">-24%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-[9px] font-black text-gray-300 uppercase tracking-widest">Alternativa</span>
                  <div className="h-px bg-gray-100 flex-1"></div>
                </div>
                
                <button 
                  onClick={() => openPixModal("Essencial Mensal", "R$ 9,90", "nucleo-chave-essencial.png")}
                  className="w-full p-4 border-2 border-dashed border-gray-100 rounded-2xl flex items-center justify-center gap-3 group hover:border-blue-200 hover:bg-blue-50/30 transition-all"
                >
                  <QrCode size={20} className="text-gray-400 group-hover:text-blue-600" />
                  <div className="text-left">
                    <p className="text-[10px] font-black text-gray-900 uppercase">Pagar com PIX</p>
                    <p className="text-[9px] text-gray-400 font-medium italic">Liberação assistida via WhatsApp</p>
                  </div>
                </button>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-[2.5rem] w-full max-w-md overflow-hidden shadow-2xl relative">
            <div className="p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 mb-6 text-sm">Escaneie o QR Code para ativar o plano <span className="font-bold text-blue-600">{selectedPlan?.name}</span></p>
              ...
              <div className="w-full space-y-3">
                <button onClick={handleCopyPix} className="w-full py-4 bg-gray-50 border-2 border-dashed border-gray-200 text-gray-700 rounded-2xl font-mono text-sm flex items-center justify-center gap-3 hover:border-blue-400 transition-all">
                  {PIX_KEY}
