...
function BuscaContent() {
  ...
  return (
    <div className="w-full md:pr-10 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20 relative px-4 md:px-0">
        ...
        {results.length > 0 ? (
          ...
          <div className="flex flex-col items-center">
            <div className="w-full text-center py-16 bg-gray-50/50 rounded-[2.5rem] border border-dashed border-gray-200 mb-8">
              ...
              {/* BARRA DE PESQUISA INTERNA NO ERRO */}
            ...
            {/* Sugestões rápidas quando dá erro */}
      ...
      {/* Footer da busca (Mantido conforme original) */}
      ...
      {/* BLOCO INSTAGRAM (Reduzido para focar na funcionalidade) */}
      <div className="flex flex-col items-center text-center mt-12">
        <a href="https://www.instagram.com/nucleobase.app/" target="_blank" className="group flex flex-col items-center gap-4">
          <div className="w-16 h-16 bg-gradient-to-tr from-[#f09433] to-[#bc1888] rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:rotate-6 transition-all">
            <Instagram size={30} />
          </div>
...
// Componente auxiliar para links rápidos no erro
