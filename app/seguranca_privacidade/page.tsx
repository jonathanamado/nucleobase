// app/seguranca_privacidade/page.tsx
"use client";
...
export default function PrivacidadeSeguranca() {
  useEffect(() => {
    window.dataLayer?.push({
      ...
      content_name: "seguranca_e_privacidade"
    });
  }, []);
  ...
  const trackClick = (label: string, destination: string) => {
    window.dataLayer?.push({
      ...
      page_location: "/seguranca_privacidade"
    });
  };
    ...
    <div className="w-full md:pr-10 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20 relative px-4 md:px-0">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-6 mt-0">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="/faq"
            onClick={() => trackClick("Central de Ajuda", "/faq")}
        ...
        <div className="lg:col-span-12 mt-4">
          <div className="bg-gray-50 border border-gray-100 p-10 md:p-14 rounded-[3.5rem] relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              <a
                href="/contato"
                onClick={() => trackClick("Acessar Canal de Apoio", "/contato")}
                className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-gray-900 text-white rounded-2xl hover:bg-black transition-all font-bold text-xs uppercase tracking-[0.2em] shadow-xl shadow-gray-200 shrink-0 cursor-pointer"
              >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <a
          ...
          onClick={() => trackClick("Instagram - Segurança", "https://www.instagram.com/nucleobase.app/")}
