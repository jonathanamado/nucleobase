...
export default function RealizarLoginPage() {
  ...
  useEffect(() => {
    window.dataLayer?.push({
      ...
      content_name: "pagina_realizar_login"
    });
  }, []);
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setIsSuccess(true);
      trackClick("Login Realizar Login Sucesso", "/minha-conta");
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      trackClick("Solicitação de Recuperação de Senha", "forgot_password");
      setView("login");
    }
    setLoading(false);
  };
    ...
    <div className="w-full bg-gray-50 flex flex-col items-center justify-center p-4 min-h-screen font-sans selection:bg-orange-100 selection:text-orange-900">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 border border-gray-100 p-8 md:p-10 flex flex-col relative overflow-hidden">
          ...
          {view === "login" ? (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center px-1">
                  ...
                  <button
                    ...
                    onClick={() => {
                      setView("forgot");
                      trackClick("Alternar para Esqueceu a Senha", "forgot_view");
                    }}
              ...
              <button
                disabled={loading}
                className="w-full bg-gray-900 text-white py-4 rounded-2xl font-black hover:bg-black transition-all shadow-xl shadow-gray-200 text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 mt-8 group disabled:opacity-50 active:scale-[0.98] cursor-pointer"
              >
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
              ...
              <button
                disabled={loading}
                className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 mt-8 group disabled:opacity-50 active:scale-[0.98] cursor-pointer"
              >
              ...
              <button
                ...
                onClick={() => {
                  setView("login");
                  trackClick("Voltar para o Login", "login_view");
                }}
                className="w-full text-gray-400 text-[10px] font-black uppercase tracking-widest mt-2 hover:text-gray-600 transition-colors cursor-pointer"
              >
                Voltar para o login
              </button>
            </form>
          ...
          <div className="mt-10 pt-8 border-t border-gray-50 flex flex-col items-center gap-6">
            ...
            <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">
              Novo por aqui?{" "}
              <a href="/cadastro" onClick={() => trackClick("Criar Conta - Realizar Login", "/cadastro")} className="text-blue-600 font-black hover:text-blue-700 transition-colors ml-1 cursor-pointer">
                Crie sua conta
              </a>
            </p>
          </div>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <a
          ...
          onClick={() => trackClick("Instagram - Realizar Login", "https://www.instagram.com/nucleobase.app/")}
