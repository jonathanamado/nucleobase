  ...
  return (
    <div className="w-full bg-white min-h-screen pb-20 animate-in fade-in duration-700">
      ...
      <article className="max-w-3xl mx-auto px-6 text-gray-700 text-lg leading-[1.8]">
        ...
        <p className="text-center text-gray-400 font-bold uppercase tracking-widest text-[10px] mb-20">
          Faturamento é vaidade. Lucro é clareza. Nucleobase é estratégia.
        </p>
      </article>

      {/* NOVA LINHA DIVISÓRIA "CONECTE-SE" PADRONIZADA */}
      <div className="max-w-4xl mx-auto px-6 mt-10 flex items-center gap-4 mb-12">
      ...
      {/* FOOTER DO ARTIGO */}
      <footer className="max-w-3xl mx-auto px-6 mt-24 pt-10 border-t border-gray-100 flex justify-between items-center">
