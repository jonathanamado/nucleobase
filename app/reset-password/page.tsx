...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    window.dataLayer?.push({
      ...
      content_name: "pagina_reset_password"
    });
  }, []);
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess(true);
      trackClick("Redefinição de Senha Concluída", "success_reset");
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 pb-20">
          ...
          <>
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gray-900 text-white py-4 rounded-2xl hover:bg-black transition-all font-bold text-sm shadow-xl flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50 mt-4 cursor-pointer"
              >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <a
          ...
          onClick={() => trackClick("Instagram - Reset Password", "https://www.instagram.com/nucleobase.app/")}
